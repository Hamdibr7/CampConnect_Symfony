...
class EquipementController extends AbstractController
{
    ...
    public function listerLesEquipementsPourUser(EquipementRepository $equipementRepository): Response
    {
        ...
        return $this->render('Front/equipements/store.html.twig', [
            'equipements' => $equipementRepository->findAll(),
        ]);
    }

    #[Route('/dashboard', name: 'app_equipement_index', methods: ['GET'])]
