...
class ReservationController extends AbstractController
{
    ...
    public function new(
        ...
        $reservation->setUtilisateurid(2); // TODO: remplacer par utilisateur connecté
...
public function RESBack(Request $request, ReservationRepository $repo, PaginatorInterface $paginator): Response
{
    $filters = [
        'camping'   => $request->query->get('camping'),
        'dateDebut' => $request->query->get('dateDebut'),
    ...
    $reservations = $paginator->paginate(
        ...
        10 // Nombre d'éléments par page pour l'admin
    );
